...
var fs = require('fs');
var settings = JSON.parse(fs.readFileSync(path.join(__dirname,
  '../../../config/settings.json'), 'utf8'));
var dbConnectionInfo = require(path.join(__dirname,
  '../../../lib/util/dbConnectionInfo.js'))(settings.dbUri);

var initDB = function initDB() {
  var dbName = dbConnectionInfo.dbName;
  var psqlConnectionStr = 'psql ' + dbConnectionInfo.dbServer;

  var dropDBCmd = psqlConnectionStr + ' -c "DROP DATABASE IF EXISTS ' +
    dbName + ';"';
