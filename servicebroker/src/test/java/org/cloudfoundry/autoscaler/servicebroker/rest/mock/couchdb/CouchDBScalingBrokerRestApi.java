...
public class CouchDBScalingBrokerRestApi {
	...
	public Response getDesignDocument(@Context final HttpServletRequest httpServletRequest,
			@PathParam("designDocType") final String designDocType, @QueryParam("include_docs") final String include_docs) {
	...
	@Path("/")
	@Produces(MediaType.APPLICATION_JSON)
	public Response getDBs(@Context final HttpServletRequest httpServletRequest, @QueryParam("include_docs") final String include_docs) {
	...
	@Path("/{docId}")
	@Produces(MediaType.APPLICATION_JSON)
	public Response getDoc(@Context final HttpServletRequest httpServletRequest, @PathParam("docId") final String docId, @QueryParam("include_docs") final String include_docs) {
//		String resultStr =  "{\"_id\":\"2d642054-5675-44b2-9304-af58b1648365\",\"_rev\":\"1-57abaeb827756fc5635abacb88bd4c75\",\"type\":\"ServiceInstance_inBroker\",\"serviceId\":\"" + TESTSERVICEID + "\",\"serverUrl\":\"" + TESTSERVERURL + "\",\"orgId\":\"" + TESTORGID + "\",\"spaceId\":\"" + TESTSPACEID + "\",\"timestamp\":1456800826562}";
		String resultStr = this.getResponse(docId,"",include_docs);
		if(resultStr.indexOf("error") >= 0){
			return RestApiResponseUtil.getResponse(404, resultStr);
		}
		else{
			return RestApiResponseUtil.getResponseOk(resultStr);
		}
	...
	@Path("/{docId}")
	@Produces(MediaType.APPLICATION_JSON)
	public Response deleteDoc(@Context final HttpServletRequest httpServletRequest,
...
//		String returnStr = "{\"ok\": true,\"id\": \"2d642054-5675-44b2-9304-af58b1648365\",\"rev\": \"2-24c637da3fa1164b1a5fe05a35456e1c\"}";
		...
		return RestApiResponseUtil.getResponse(201, jsonStr);
	...
	@Consumes(MediaType.APPLICATION_JSON)
	@Produces(MediaType.APPLICATION_JSON)
	public Response addDoc1(@Context final HttpServletRequest httpServletRequest,
			String jsonString) {
//		String returnStr = "{\"ok\": true,\"id\": \"2d642054-5675-44b2-9304-af58b1648365\",\"rev\": \"2-24c637da3fa1164b1a5fe05a35456e1c\"}";
	...
	@Consumes(MediaType.APPLICATION_JSON)
	@Produces(MediaType.APPLICATION_JSON)
	public Response addDoc(@Context final HttpServletRequest httpServletRequest,
			@PathParam("docId") String docId, String jsonString) {
//		String returnStr = "{\"ok\": true,\"id\": \"2d642054-5675-44b2-9304-af58b1648365\",\"rev\": \"2-24c637da3fa1164b1a5fe05a35456e1c\"}";
		String jsonStr = CouchDBDocumentManager.getInstance().addDocument(jsonString).toString();
		return RestApiResponseUtil.getResponse(201, jsonStr);
