...
public class RestApiResponseUtil {
	public static final String CLASS_NAME = RestApiResponseUtil.class.getName();
	...
	private static String getErrorJsonString(String errDesc)
	{
		return "{\"description\" : \""+errDesc+"\"}";		
	}
