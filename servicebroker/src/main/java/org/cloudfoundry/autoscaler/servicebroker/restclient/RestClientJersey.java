...
public class RestClientJersey implements IRestClient {
	...
	private class IRestResourceBuilder implements IRestClient.IRestResourceBuilder {
		...
		@Override
		public IRestClient.IRestResourceBuilder header(String name, Object value) {
			builder.header(name, value);
			return this;
		}

		@Override
		public IRestClient.IRestResourceBuilder accept(MediaType mediaType) {
			builder.accept(mediaType);
			return this;
		}

		@Override
		public IRestClient.IRestResourceBuilder accept(String mediaType) {
			builder.accept(mediaType);
			return this;
		}

		@Override
		public IRestClient.IRestResourceBuilder type(MediaType mediaType) {
			builder.type(mediaType);
			return this;
		}

		@Override
		public IRestClient.IRestResourceBuilder type(String mediaType) {
			builder.type(mediaType);
			return this;
		}

		@Override
		public IRestClient.IRestResourceBuilder cookie(Cookie cookie) {
