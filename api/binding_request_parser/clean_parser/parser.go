...
var _ binding_request_parser.Parser = CleanBindingRequestParser{}
...
func (p CleanBindingRequestParser) Parse(bindingReqParams string) (binding_request_parser.Parameters, error) {
