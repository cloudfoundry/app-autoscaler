...
module.exports = function(settings) {
  ...
  router.get("/:app_id/metric_histories/:metric_type", function(req, resp) {
    ...
    if (!parseResult.valid) {
      logger.error("Failed to get metrics", { "app_id": appId, "metric_type":metricType, "start-time": startTime, "end-time": endTime, "order-direction": orderDirection, "page": page, "results-per-page": resultsPerPage, "message": parseResult.message });
