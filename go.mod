...
require (
	...
	code.cloudfoundry.org/loggregator-agent-release/src v0.0.0-20260115101203-51e4361abdf1
...
replace google.golang.org/genproto => google.golang.org/genproto v0.0.0-20260114163908-3f89685c29c3

require (
	code.cloudfoundry.org/go-diodes v0.0.0-20260112063157-4b000d565325 // indirect
	code.cloudfoundry.org/go-metric-registry v0.0.0-20260113113534-1f0399660faf // indirect
