...
require (
	...
	code.cloudfoundry.org/loggregator-agent-release/src v0.0.0-20260817083708-329f564e7a9b
...
require (
	...
	code.cloudfoundry.org/go-metric-registry v0.0.0-20260811073445-dd3e9d2bd72b // indirect
