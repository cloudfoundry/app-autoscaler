...
public class ActiveScheduleDaoImplTest {
	...
	public void testCreateAndFindActiveSchedule() {
		...
		assertThat("It should have no active schedule", testDataDbUtil.getNumberOfActiveSchedulesByScheduleId(scheduleId),
				is(0L));

		activeScheduleDao.create(activeScheduleEntity);

		assertThat("It should have one active schedule", testDataDbUtil.getNumberOfActiveSchedulesByScheduleId(scheduleId),
				is(1L));
	...
	public void testDeleteActiveSchedule() {
		...
		assertThat("It should have one active schedule",
				testDataDbUtil.getNumberOfActiveSchedulesByScheduleId(activeScheduleId), is(1L));
		...
		assertThat("It should have no active schedule",
				testDataDbUtil.getNumberOfActiveSchedulesByScheduleId(activeScheduleId), is(0L));
	}
	...
	public void testDeleteAllActiveSchedulesByAppId() {
		...
		assertThat("It should have 3 active schedules", testDataDbUtil.getNumberOfActiveSchedulesByAppId(appId), is(3L));

		activeScheduleDao.deleteActiveSchedulesByAppId(appId);

		assertThat("It should have no active schedules", testDataDbUtil.getNumberOfActiveSchedulesByAppId(appId), is(0L));
