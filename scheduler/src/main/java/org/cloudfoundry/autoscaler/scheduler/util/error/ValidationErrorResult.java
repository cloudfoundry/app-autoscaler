...
public class ValidationErrorResult {
	...
	boolean initialised;
	private List<ValidationError> errorList; // NOTE: lLeave error list null until, have actual errors
	...
	public void addErrorForDatabaseValidationException(DatabaseValidationException dve, String messageCode, Object... arguments) {
