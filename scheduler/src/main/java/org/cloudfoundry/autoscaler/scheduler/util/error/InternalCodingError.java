 ...
 * <p>
 * This exception will result in a dedicated error page that indicates some coding has been done wrong.
 * <p>
 * An example, when a method needs to assume a caller is going to provide certain information, 
