...
export AUTOSCALER_ORG_MANAGER_USER="${AUTOSCALER_ORG_MANAGER_USER:-org-manager-user}"
debug "AUTOSCALER_ORG_MANAGER_USER: ${AUTOSCALER_ORG_MANAGER_USER}"
...
export INFRASTRUCTURE="${INFRASTRUCTURE:-OSS}"
debug "INFRASTRUCTURE: ${INFRASTRUCTURE}"
log "set up vars: INFRASTRUCTURE=${INFRASTRUCTURE}"
