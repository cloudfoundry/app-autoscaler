...
public class ScalingHistoryRestApi {
	...
	public Response getHistoryList(@Context final HttpServletRequest httpServletRequest, @QueryParam ("appId") String appId, @QueryParam ("startTime") String startTime, 
			...
			@QueryParam ("maxCount") String maxCount, @QueryParam ("scaleType") String scaleType, @QueryParam ("timeZone") String timeZone){
	...
	@GET
	@Produces (MediaType.APPLICATION_JSON)
	public Response getHistoryCount(@Context final HttpServletRequest httpServletRequest, @QueryParam ("appId") String appId, @QueryParam ("startTime") String startTime, 
			@QueryParam ("endTime") String endTime, @QueryParam ("status") String status,
