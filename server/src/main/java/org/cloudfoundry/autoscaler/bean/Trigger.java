...
/**
 * To remain backward compatibility, the monitor checks whether conditionList is
 * empty. If empty, it uses the condition defined in the fields of Tigger, If
 * not, it ignores the condition defined in the fields of Trigger but uses those
...
public class Trigger implements Serializable {
	...
	public String toString() {
		return String.format(
				" The app %s[appId] 's %s[metricType] has been %s[triggerId] than %f %s[metricThreshold] for more than %d seconds[breachDuration]",
				this.appId, this.metric, this.triggerId, this.metricThreshold, this.unit, this.breachDurationSecs);
	}
