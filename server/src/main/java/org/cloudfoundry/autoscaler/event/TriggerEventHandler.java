package org.cloudfoundry.autoscaler.event;
...
public class TriggerEventHandler {
	...
	/**
	 * Checks if last scaling action is completed
	 * 
	 * @return true if it's completed
	 */
	private boolean isLastScalingCompleted() {
		if (appState.getInstanceCountState() == ScalingStateManager.SCALING_STATE_COMPLETED
				|| appState.getInstanceCountState() == ScalingStateManager.SCALING_STATE_FAILED)
			return true;
		return false;
	}
