...
public class CloudControllerRestApi {
	...
	public Response getSpaceByApplication(@Context final HttpServletRequest httpServletRequest,
		...
		String jsonStr = "{ \"total_results\": 1,\"total_pages\": 1,\"prev_url\": null,\"next_url\": null,\"resources\": [{\"metadata\": {\"guid\": \"" + TESTSPACEID + "\",\"url\": \"/v2/spaces/" + TESTSPACEID + "\",\"created_at\": \"2015-03-19T08:12:35Z\",\"updated_at\": null},\"entity\": {\"name\": \"TESTSPACE\",\"organization_guid\": \"" + TESTORGID + "\",\"space_quota_definition_guid\": null,\"allow_ssh\": true,\"organization_url\": \"/v2/organizations/" + TESTORGID + "\",\"developers_url\": \"/v2/spaces/" + TESTSPACEID + "/developers\",\"managers_url\": \"/v2/spaces/" + TESTSPACEID + "/managers\",\"auditors_url\": \"/v2/spaces/" + TESTSPACEID + "/auditors\",\"apps_url\": \"/v2/spaces/" + TESTSPACEID + "/apps\",\"routes_url\": \"/v2/spaces/" + TESTSPACEID + "/routes\",\"domains_url\": \"/v2/spaces/" + TESTSPACEID + "/domains\",\"service_instances_url\": \"/v2/spaces/" + TESTSPACEID + "/service_instances\",\"app_events_url\": \"/v2/spaces/" + TESTSPACEID + "/app_events\",\"events_url\": \"/v2/spaces/" + TESTSPACEID + "/events\",\"security_groups_url\": \"/v2/spaces/" + TESTSPACEID + "/security_groups\"}}]}";
		return RestApiResponseHandler.getResponseOk(jsonStr);
	...
	public Response getOrgnazation(@Context final HttpServletRequest httpServletRequest,
			@QueryParam("q") String query) {
		String jsonStr = "{\"total_results\":1,\"total_pages\":1,\"prev_url\":null,\"next_url\":null,\"resources\":[{\"metadata\":{\"guid\":\"" + TESTORGID + "\",\"url\":\"/v2/organizations/" + TESTORGID + "\",\"created_at\":\"2015-03-19T08:12:34Z\",\"updated_at\":null},\"entity\":{\"name\":\"" + TESTORGID + "\",\"billing_enabled\":false,\"quota_definition_guid\":\"2934775d-2c62-496b-9332-30fcb804dad4\",\"status\":\"active\",\"quota_definition_url\":\"/v2/quota_definitions/2934775d-2c62-496b-9332-30fcb804dad4\",\"spaces_url\":\"/v2/organizations/" + TESTORGID + "/spaces\",\"domains_url\":\"/v2/organizations/" + TESTORGID + "/domains\",\"private_domains_url\":\"/v2/organizations/" + TESTORGID + "/private_domains\",\"users_url\":\"/v2/organizations/" + TESTORGID + "/users\",\"managers_url\":\"/v2/organizations/" + TESTORGID + "/managers\",\"billing_managers_url\":\"/v2/organizations/" + TESTORGID + "/billing_managers\",\"auditors_url\":\"/v2/organizations/" + TESTORGID + "/auditors\",\"app_events_url\":\"/v2/organizations/" + TESTORGID + "/app_events\",\"space_quota_definitions_url\":\"/v2/organizations/" + TESTORGID + "/space_quota_definitions\"}}]}";
		return RestApiResponseHandler.getResponseOk(jsonStr);
	...
	public Response getApplicationSummaryById(@Context final HttpServletRequest httpServletRequest,
			@PathParam("appId") final String appId) {
		String jsonStr = "{\"guid\":\"" + TESTAPPID + "\",\"name\":\"thenodejsdemoapp\",\"routes\":[{\"guid\":\"81730881-bcbc-446d-a23d-e2e87b475115\",\"host\":\"thenodejsdemoapp\",\"domain\":{\"guid\":\"80f7b34d-0c35-47d5-b14a-c0974a9d9b8b\",\"name\":\"stage1.mybluemix.net\"}}],\"running_instances\":1,\"services\":[{\"guid\":\"" + TESTSERVICEID + "\",\"name\":\"ttt1\",\"bound_app_count\":1,\"last_operation\":{\"type\":\"create\",\"state\":\"succeeded\",\"description\":\"\",\"updated_at\":null,\"created_at\":\"2016-03-21T08:41:09Z\"},\"dashboard_url\":\"https://Scaling4.stage1.ng.bluemix.net/autoScaling.jsp?org_id=" + TESTORGID + "&space_id=" + TESTSPACEID + "&service_id=" + TESTSERVICEID + "\",\"service_plan\":{\"guid\":\"8a5481ca-d1ce-479e-9098-5881a8fb974b\",\"name\":\"free\",\"service\":{\"guid\":\"ea3d5633-89ac-4a92-9c21-c93952021d4b\",\"label\":\"Auto-Scaling\",\"provider\":null,\"version\":null}}}],\"available_domains\":[{\"guid\":\"80f7b34d-0c35-47d5-b14a-c0974a9d9b8b\",\"name\":\"stage1.mybluemix.net\",\"router_group_guid\":null}],\"name\":\"thenodejsdemoapp\",\"production\":false,\"space_guid\":\"" + TESTSPACEID + "\",\"stack_guid\":\"088e0657-127d-4ab9-b8c4-1401d3aa8c10\",\"buildpack\":null,\"detected_buildpack\":\"SDK for Node.js(TM) (ibm-node.js-4.3.2, buildpack-v3.2-20160315-1257)\",\"environment_json\":{},\"memory\":1024,\"instances\":1,\"disk_quota\":1024,\"state\":\"STARTED\",\"version\":\"9245bcf6-5b90-4426-a24e-05be5fa4fb75\",\"command\":null,\"console\":false,\"debug\":null,\"staging_task_id\":\"ba176b4af3584ed9890ec819cd020a17\",\"package_state\":\"STAGED\",\"health_check_type\":\"port\",\"health_check_timeout\":null,\"staging_failed_reason\":null,\"staging_failed_description\":null,\"diego\":false,\"docker_image\":null,\"package_updated_at\":\"2016-03-21T08:39:50Z\",\"detected_start_command\":\"./vendor/initial_startup.rb\",\"enable_ssh\":true,\"docker_credentials_json\":{\"redacted_message\":\"[PRIVATE DATA HIDDEN]\"},\"ports\":null}";
		return RestApiResponseHandler.getResponseOk(jsonStr);
	...
	public Response getSpacesApplications(@Context final HttpServletRequest httpServletRequest,
		...
		String jsonStr = "{\"total_results\":5,\"total_pages\":1,\"prev_url\":null,\"next_url\":null,\"resources\":[{\"metadata\":{\"guid\":\"" + TESTAPPID + "\",\"url\":\"/v2/apps/" + TESTAPPID + "\",\"created_at\":\"2016-03-21T08:39:36Z\",\"updated_at\":\"2016-03-31T02:21:28Z\"},\"entity\":{\"name\":\"thenodejsdemoapp\",\"production\":false,\"space_guid\":\"" + TESTSPACEID + "\",\"stack_guid\":\"088e0657-127d-4ab9-b8c4-1401d3aa8c10\",\"buildpack\":null,\"detected_buildpack\":\"SDKforNode.js(TM)(ibm-node.js-4.3.2,buildpack-v3.2-20160315-1257)\",\"environment_json\":{},\"memory\":1024,\"instances\":1,\"disk_quota\":1024,\"state\":\"STARTED\",\"version\":\"9245bcf6-5b90-4426-a24e-05be5fa4fb75\",\"command\":null,\"console\":false,\"debug\":null,\"staging_task_id\":\"ba176b4af3584ed9890ec819cd020a17\",\"package_state\":\"STAGED\",\"health_check_type\":\"port\",\"health_check_timeout\":null,\"staging_failed_reason\":null,\"staging_failed_description\":null,\"diego\":false,\"docker_image\":null,\"package_updated_at\":\"2016-03-21T08:39:50Z\",\"detected_start_command\":\"./vendor/initial_startup.rb\",\"enable_ssh\":true,\"docker_credentials_json\":{\"redacted_message\":\"[PRIVATEDATAHIDDEN]\"},\"ports\":null,\"space_url\":\"/v2/spaces/" + TESTSPACEID + "\",\"stack_url\":\"/v2/stacks/088e0657-127d-4ab9-b8c4-1401d3aa8c10\",\"events_url\":\"/v2/apps/" + TESTAPPID + "/events\",\"service_bindings_url\":\"/v2/apps/" + TESTAPPID + "/service_bindings\",\"routes_url\":\"/v2/apps/" + TESTAPPID + "/routes\"}}]}";
		return RestApiResponseHandler.getResponseOk(jsonStr);
	...
	public Response updateApplicationInstances(@Context final HttpServletRequest httpServletRequest,
		...
		String jsonStr = "{\"metadata\":{\"guid\":\"" + TESTAPPID + "\",\"url\":\"/v2/apps/" + TESTAPPID + "\",\"created_at\":\"2016-03-21T08:39:36Z\",\"updated_at\":\"2016-03-31T07:24:33Z\"},\"entity\":{\"name\":\"thenodejsdemoapp\",\"production\":false,\"space_guid\":\"" + TESTSPACEID + "\",\"stack_guid\":\"088e0657-127d-4ab9-b8c4-1401d3aa8c10\",\"buildpack\":null,\"detected_buildpack\":\"SDKforNode.js(TM)(ibm-node.js-4.3.2,buildpack-v3.2-20160315-1257)\",\"environment_json\":{},\"memory\":1024,\"instances\":1,\"disk_quota\":1024,\"state\":\"STARTED\",\"version\":\"9245bcf6-5b90-4426-a24e-05be5fa4fb75\",\"command\":null,\"console\":false,\"debug\":null,\"staging_task_id\":\"ba176b4af3584ed9890ec819cd020a17\",\"package_state\":\"STAGED\",\"health_check_type\":\"port\",\"health_check_timeout\":null,\"staging_failed_reason\":null,\"staging_failed_description\":null,\"diego\":false,\"docker_image\":null,\"package_updated_at\":\"2016-03-21T08:39:50Z\",\"detected_start_command\":\"./vendor/initial_startup.rb\",\"enable_ssh\":true,\"docker_credentials_json\":{\"redacted_message\":\"[PRIVATEDATAHIDDEN]\"},\"ports\":null,\"space_url\":\"/v2/spaces/" + TESTSPACEID + "\",\"stack_url\":\"/v2/stacks/088e0657-127d-4ab9-b8c4-1401d3aa8c10\",\"events_url\":\"/v2/apps/" + TESTAPPID + "/events\",\"service_bindings_url\":\"/v2/apps/" + TESTAPPID + "/service_bindings\",\"routes_url\":\"/v2/apps/" + TESTAPPID + "/routes\"}}";
		return RestApiResponseHandler.getResponseOk(jsonStr);
